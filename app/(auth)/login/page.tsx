    ...
    <div className="min-h-screen bg-[#0A0F1E] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-2/5 min-w-[468px]">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#F0F4FF] tracking-tight">Selamat datang kembali</h1>
          <p className="text-sm md:text-md text-[#8892B0] mt-1">Masuk untuk melanjutkan catatanmu</p>
        </div>
